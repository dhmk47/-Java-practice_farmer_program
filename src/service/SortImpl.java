...
//		};
	...
	public void executeSortBySeason(ArrayList<Product> productList) {
		...
		if(choice == 1) {
			productList.sort((o1, o2) -> o1.getSeason().charAt(0) - o2.getSeason().charAt(0));
			
		}else if(choice == 2) {
			productList.sort((o1, o2) -> o2.getSeason().charAt(0) - o1.getSeason().charAt(0));
	...
	public void executeSortByCode(ArrayList<Product> productList) {
		...
		if(choice == 1) {
			productList.sort((o1, o2) -> o1.getProduct_code() - o2.getProduct_code());
		}else if(choice == 2) {
			productList.sort((o1, o2) -> o2.getProduct_code() - o1.getProduct_code());
		}else {
